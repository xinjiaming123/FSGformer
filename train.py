...
import os
import torch
from train_helper_FSGformer import Trainer
...
def parse_args():
    ...
    parser.add_argument('--dataset', default='ccd', help='dataset name: ccd，dgcd')
    ...
    parser.add_argument('--val-start', type=int, default=70,
    ...
    parser.add_argument('--run-name', default='FSGformer', help='run name for wandb interface/logging')
