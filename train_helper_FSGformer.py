...
from datasets.crowd import  Crowd_fish

# from models import vgg19
from Networks import FSGformer
...
class Trainer(object):
    ...
    def setup(self):
        args = self.args
        sub_dir = (
            "FSGformer/{}_12-1-input-{}_wot-{}_wtv-{}_reg-{}_nIter-{}_normCood-{}".format(
                args.run_name,
                args.crop_size,
                args.wot,
                args.wtv,
        ...
        self.model = FSGformer.alt_gvt_small(pretrained=True)
        self.model.to(self.device)
        self.optimizer = optim.AdamW(
            self.model.parameters(), lr=args.lr, weight_decay=args.weight_decay
        )
        # self.optimizer = optim.SGD(
        #     self.model.parameters(), lr=args.lr, momentum=0.9, weight_decay=args.weight_decay
        # )
        ...
        if args.wandb:
            ...
            config=args, project="FSGformer", name=args.run_name
        )
        else : 
